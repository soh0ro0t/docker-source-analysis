...
3.9 docker 主作目录下创建containers目录
...
3.11 检测和配置EnableSelinuxSupport
     检测是否设置Selinux选项，是则进行系统配置；否则关闭系统配置。

3.12 创建LayerDownloader和LayerUploader
 。
3.13 创建image/aufs/imagedb目录
...
3.15 创建distribution目录

3.16 创建events

3.17 创建image/aufs/repositories.json
